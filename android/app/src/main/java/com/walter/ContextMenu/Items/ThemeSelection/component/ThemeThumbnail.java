...
public class ThemeThumbnail extends LinearLayout {
    ...
    public ThemeThumbnail(Context context,
                         int id,
                         int radiusDp,
                         String imageUrl,
        ...
        this.menuContext.onCurrentThemeUpdate(()->{
            this.activeHandler();
        });
        this.activeHandler();
    ...
    private void activeHandler(){
        if(this.id == menuContext.currentThemeId){
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        if (!isDragging  && onClick != null)  {
                            ...
                            onClick.accept(ThemeThumbnail.this.id);
                        }
                        isDragging = false;
                        return true;
    ...
    // Method to update the theme name after creation
